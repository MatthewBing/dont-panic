...
public class FlickeringLight2 : MonoBehaviour {
    ...
    IEnumerator setupLight(float time)
    {
        yield return new WaitForSeconds(0);
...
void Start ()
    {
        ...
        light.enabled = false;
        StartCoroutine(slowLightTurnon(0f));
        StartCoroutine(setupLight(5f));
...
[CustomEditor(typeof(FlickeringLight2))]
public class MyScriptEditor : Editor
{
    public override void OnInspectorGUI()
    {
        ...
        var flicker = target as FlickeringLight2;
